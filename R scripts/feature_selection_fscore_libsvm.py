#!/usr/bin/env python
# Use in CLI
# libSVM should be installed in the system. Check libSVM official site
# usage: ./feature_selection_fscore_libsvm.py training_file
# similar usage for test_file
# training_file and test_file both are in .csv format. Rows are samples and columns are features
